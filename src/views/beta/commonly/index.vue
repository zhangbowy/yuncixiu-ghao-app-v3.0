<template>
  <div ref="commonly" v-loading="loading" class="commonly-beta">
    ...
    <div class="design_info_wrap">
      <van-cell title="花样名称" :value="currentFigure.design_name" />
      <van-cell title="最佳高度" :value="`${currentFigure.best_height}mm`" />
      <van-cell title="最小高度" :value="`${currentFigure.min_height}mm`" />
      <van-cell title="最大高度" :value="`${currentFigure.max_height}mm`" />
      <van-cell title="设计师" :value="currentFigure.designer.designer_name">
        <template>
          <span class="author-name">{{ currentFigure.designer.designer_name }}</span>
          <img class="author-avatar" :src="currentFigure.designer.avatar_url">
        </template>
      </van-cell>
      <van-cell title="工艺单" :value="currentFigure.designer.designer_name">
        <template>
          <img class="txt-png" :src="currentFigure.txt_png_path" @click="look_txt_png(currentFigure.txt_png_path)">
        </template>
      </van-cell>
      <van-cell-group title="花样换色顺序" inset>
        <van-cell>
          <template>
...
export default {
  components: {
    ...
    'preview-txt-modal': PreviewModal,
